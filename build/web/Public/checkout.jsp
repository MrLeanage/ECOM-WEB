    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="${pageContext.request.contextPath}/Public/img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
                <a href="#" class="fav-nav"><img src="${pageContext.request.contextPath}/Public/img/core-img/favorites.png" alt=""> Favourite</a>
                <a href="#" class="search-nav"><img src="${pageContext.request.contextPath}/Public/img/core-img/search.png" alt=""> Search</a>
            </div>
            <!-- Social Button -->
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="${pageContext.request.contextPath}/Public/index.html"><img src="${pageContext.request.contextPath}/Public/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
